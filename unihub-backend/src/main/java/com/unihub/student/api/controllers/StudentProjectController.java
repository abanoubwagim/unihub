...
public class StudentProjectController {
    ...
    private final StudentProjectUseCase projectUseCase;
    ...
    public ResponseEntity<PageResponse<ProjectResponse>> getAll(
        ...
        return ResponseEntity.ok(projectUseCase.getAll(userId, pageable));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ProjectResponse> getOne(Authentication authentication, @PathVariable UUID id) {
        UUID userId = UUID.fromString(authentication.getName());
        return ResponseEntity.ok(projectUseCase.getOne(userId, id));
    }
    ...
    public ResponseEntity<Void> delete(Authentication authentication, @PathVariable UUID id) {
        UUID userId = UUID.fromString(authentication.getName());
        projectUseCase.delete(userId, id);
